...
class taskInputDateVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let todayBtn = UIBarButtonItem(title: "Hoje", style: UIBarButtonItemStyle.plain, target: self, action: #selector(taskInputDateVC.toolbarToToday))
        
        let okBarBtn = UIBarButtonItem(barButtonSystemItem: UIBarButtonSystemItem.done, target: self, action: #selector(taskInputDateVC.donePressed))
    ...
    @IBAction func startDateEdit(sender: UITextField){
        ...
        datePickerView.addTarget(self, action: #selector(taskInputDateVC.datePickerValueChanged), for: UIControlEvents.valueChanged)
    }
